...
function result() {
    ...
    let yItem = randomValueFromArray(insertY); /*creating new variables*/
    let zItem = randomValueFromArray(insertZ);

    newStory = newStory.replace(':insertx:',xItem); /*replacing placeholders*/
  ...
  if(customName.value !== '') {
    ...
    newStory = newStory.replace('Bob', name) /*replacing bob*/
